  ...
  return (
    ...
    >
      ...
      <p className="mb-3">In May of 2024, I&apos;m graduating from KYH (Higher Vocational Education) where I&apos;ve spent two years studying to become a
        ...
        <span> most about programming is the ability to bring various projects to life and witness them in action on the screen. I have experience with </span>
        ...
        <span className="font-medium"> I am currently looking for a  full-time position</span> as a Frontend
